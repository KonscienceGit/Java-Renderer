...
public class MyRenderer implements GLEventListener {
    ...
    /**
     * Génère et initialise le Vertex Array Object, un objet comprenant un VBO actif ainsi que ses attributs.
     * <p/>
    ...
    private void setupVBO(GL4 gl) {
        ...
        gl.glBufferData(GL_ARRAY_BUFFER, vertexBuffer.capacity() * Float.BYTES, vertexBuffer, GL_STATIC_DRAW);// crée et initialise la banque de données d'un
                                                                                                              // buffer object
    }
    ...
    private void setupVBOAttribs(GL4 gl) {
        ...
        gl.glVertexAttribPointer(pos_att_location, positionAttributeNumber, GL_FLOAT, false, vertexStride, 0);// definis la position de l'attribut dans le
                                                                                                              // buffer
